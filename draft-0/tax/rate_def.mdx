...
| ----- | ---- | ------------------------- |
| <code>rate</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-TAX-RATEDEF-01`<br />Rate is required |
| <code>name</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-TAX-RATEDEF-02`<br />Name is required |
| <code>values</code> | <ul class="gobl-test"><li>Date order</li></ul> | `GOBL-TAX-RATEDEF-03`<br />Rate values must be in descending chronological order |
| <code>values[*].percent</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-TAX-RATEDEF-01`<br />Rate value percent is required |
