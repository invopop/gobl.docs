...
`https://gobl.org/draft-0/tax/addon-def#/$defs/Scenario`
...
| Note | `note` | [tax.ScenarioNote](/draft-0/tax/scenario_note) | A note to be added to the document if the scenario is applied. |
