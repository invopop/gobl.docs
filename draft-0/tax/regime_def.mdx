...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-TAX-REGIMEDEF-01</code> | country | present | country code is required |
| <code>GOBL-TAX-REGIMEDEF-02</code> | name | present | name is required |
| <code>GOBL-TAX-REGIMEDEF-03</code> | time_zone | present | time zone is required |
| <code>GOBL-TAX-REGIMEDEF-04</code> | time_zone | valid time zone | time zone must be valid |
| <code>GOBL-TAX-REGIMEDEF-05</code> | categories | length between 1 and 0 | at least one category is required |
