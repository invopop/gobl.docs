...
| Scheme       | `scheme`  | [cbc.Code](/draft-0/cbc/code)                         |      | Scheme is an optional field that may be used to override the tax regime's default scheme. Many electronic formats such as UBL or CII define an equivalent field which may be added.                                                                                                         |
