...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-TAX-IDENTITY-01</code> | country | present | tax id country code is always required |
| <code>GOBL-TAX-IDENTITY-02</code> | code | matches ^[A-Z0-9Ñ\&]+$ | tax id code must have a valid format |
| <code>GOBL-GR-TAX-IDENTITY-01</code> | code | code in [EL]; valid | invalid Greek VAT identity code |
