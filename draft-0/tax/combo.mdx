...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-TAX-COMBO-01</code> |  | category in regime | tax category not valid for regime |
| <code>GOBL-TAX-COMBO-02</code> |  | key in category | tax combo key not valid for category in regime |
| <code>GOBL-TAX-COMBO-03</code> |  | rate in key | tax combo rate not valid for key in regime |
| <code>GOBL-TAX-COMBO-04</code> |  | percent valid for key | tax combo percent required or invalid for key in regime |
| <code>GOBL-TAX-COMBO-05</code> |  | surcharge requires percent | tax combo surcharge requires percent in regime |
| <code>GOBL-TAX-COMBO-06</code> |  | extension keys defined | tax combo extension key not defined in regime |
