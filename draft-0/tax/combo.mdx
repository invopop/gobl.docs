...
| ----- | ---- | ------------------------- |
| <small>document</small> | <ul class="gobl-test"><li>Category in regime</li></ul> | `GOBL-TAX-COMBO-01`<br />Tax category not valid for regime |
| <small>document</small> | <ul class="gobl-test"><li>Key in category</li></ul> | `GOBL-TAX-COMBO-02`<br />Tax combo key not valid for category in regime |
| <small>document</small> | <ul class="gobl-test"><li>Rate in key</li></ul> | `GOBL-TAX-COMBO-03`<br />Tax combo rate not valid for key in regime |
| <small>document</small> | <ul class="gobl-test"><li>Percent valid for key</li></ul> | `GOBL-TAX-COMBO-04`<br />Tax combo percent required or invalid for key in regime |
| <small>document</small> | <ul class="gobl-test"><li>Surcharge requires percent</li></ul> | `GOBL-TAX-COMBO-05`<br />Tax combo surcharge requires percent in regime |
| <small>document</small> | <ul class="gobl-test"><li>Extension keys defined</li></ul> | `GOBL-TAX-COMBO-06`<br />Tax combo extension key not defined in regime |
