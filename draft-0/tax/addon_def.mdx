...
| Extensions  | `extensions`  | array of [cbc.KeyDefinition](/draft-0/cbc/key_definition) | true | Extensions defines the list of extensions that are associated with an add-on.                                                                         |
...
| Inboxes     | `inboxes`     | array of [cbc.KeyDefinition](/draft-0/cbc/key_definition) |      | Inboxes is a list of keys that are used to identify where copies of documents can be sent.                                                            |
