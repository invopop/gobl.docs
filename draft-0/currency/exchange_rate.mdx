...
| ----- | ---- | ------------------------- |
| <code>from</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-CURRENCY-EXCHANGERATE-01`<br />From currency is required |
| <code>to</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-CURRENCY-EXCHANGERATE-02`<br />To currency is required |
| <code>at</code> | <ul class="gobl-test"><li>Not zero</li></ul> | `GOBL-CURRENCY-EXCHANGERATE-03`<br />Date/time must not be zero |
| <code>amount</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-CURRENCY-EXCHANGERATE-04`<br />Amount must be positive |
