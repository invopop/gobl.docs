...
| ----- | ---- | ------------------------- |
| <code>prv</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-HEAD-STAMP-01`<br />Stamp provider is required |
| <code>val</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-HEAD-STAMP-02`<br />Stamp value is required |
