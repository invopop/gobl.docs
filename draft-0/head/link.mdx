...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-HEAD-LINK-06</code> |  | no digest without MIME | link digest must be nil when MIME type is not provided |
| <code>GOBL-HEAD-LINK-01</code> | key | present | link key is required |
| <code>GOBL-HEAD-LINK-02</code> | category | valid or empty | link category is not valid |
| <code>GOBL-HEAD-LINK-03</code> | url | present | link URL is required |
| <code>GOBL-HEAD-LINK-04</code> | url | url | link URL must be a valid URL |
| <code>GOBL-HEAD-LINK-05</code> | mime | valid or empty MIME | link MIME type is not valid |
