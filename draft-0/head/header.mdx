...
| ----- | ---- | ------------------------- |
| <code>uuid</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li><li>Has timestamp</li></ul> | `GOBL-HEAD-HEADER-01`<br />Header must contain a UUID v1 or v7 with timestamp |
| <code>dig</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-HEAD-HEADER-02`<br />Header must have a digest |
| <code>stamps</code> | <ul class="gobl-test"><li>No duplicate stamps</li></ul> | `GOBL-HEAD-HEADER-03`<br />Duplicate stamp providers are not allowed |
| <code>links</code> | <ul class="gobl-test"><li>No duplicate links</li></ul> | `GOBL-HEAD-HEADER-04`<br />Duplicate link keys are not allowed |
