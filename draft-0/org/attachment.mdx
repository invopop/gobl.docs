...
| ----- | ---- | ------------------------- |
| <code>url</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li><li>Url</li></ul> | `GOBL-ORG-ATTACHMENT-01`<br />Attachment URL must be valid |
| <code>mime</code> | <ul class="gobl-test"><li>One of [application/pdf, image/jpeg, image/png, text/csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.oasis.opendocument.spreadsheet]</li></ul> | `GOBL-ORG-ATTACHMENT-02`<br />Attachment MIME type must be of an expected types defined in EN16931-1:2017 |
