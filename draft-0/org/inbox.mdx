...
| ----- | ---- | ------------------------- |
| <small>document</small> | <ul class="gobl-test"><li>One of code, url, email required</li></ul> | `GOBL-ORG-INBOX-01`<br />Inbox requires a code, url, or email |
| <small>document</small> | <ul class="gobl-test"><li>Url exclusive</li></ul> | `GOBL-ORG-INBOX-02`<br />Inbox url must be blank when code or email is provided |
| <small>document</small> | <ul class="gobl-test"><li>Email exclusive</li></ul> | `GOBL-ORG-INBOX-03`<br />Inbox email must be blank when code or url is provided |
| <code>url</code> | <ul class="gobl-test"><li>Url</li></ul> | `GOBL-ORG-INBOX-04`<br />Inbox url must be valid |
| <code>email</code> | <ul class="gobl-test"><li>Email-format</li></ul> | `GOBL-ORG-INBOX-05`<br />Inbox email must be valid |
