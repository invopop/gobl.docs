...
| ----- | ---- | ------------------------- |
| <code>name</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ORG-ITEM-01`<br />Item name is required |
| <code>price</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-ORG-ITEM-02`<br />Item price must be zero or positive |
