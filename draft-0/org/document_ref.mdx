...
| ----- | ---- | ------------------------- |
| `code` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ORG-DOCUMENTREF-01`<br />Document reference code is required |
| `issue_date` | <ul class="gobl-test"><li>Not zero</li></ul> | `GOBL-ORG-DOCUMENTREF-02`<br />Document reference issue date must not be zero |
| `url` | <ul class="gobl-test"><li>Url</li></ul> | `GOBL-ORG-DOCUMENTREF-03`<br />Document reference URL must be valid |
