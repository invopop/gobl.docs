...
| Type | `type` | [cbc.Key](/draft-0/cbc/key) | Type of the document referenced according to the defined schema or that of the parent document. |
...
| Code | `code` | [cbc.Code](/draft-0/cbc/code) | Source document's code or other identifier. |
...
| ----- | ---- | ------------------------- |
| <code>code</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ORG-DOCUMENTREF-01`<br />Document reference code is required |
| <code>issue_date</code> | <ul class="gobl-test"><li>Not zero</li></ul> | `GOBL-ORG-DOCUMENTREF-02`<br />Document reference issue date must not be zero |
| <code>url</code> | <ul class="gobl-test"><li>Url</li></ul> | `GOBL-ORG-DOCUMENTREF-03`<br />Document reference URL must be valid |
