...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-ORG-DOCUMENTREF-01</code> | code | present | document reference code is required |
| <code>GOBL-ORG-DOCUMENTREF-02</code> | issue_date | not zero | document reference issue date must not be zero |
| <code>GOBL-ORG-DOCUMENTREF-03</code> | url | url | document reference URL must be valid |
