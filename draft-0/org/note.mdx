...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-ORG-NOTE-01</code> | text | present | note text is required |
| <code>GOBL-ORG-NOTE-02</code> | key | one of [goods, payment, payment-method, payment-term, legal, dangerous-goods, ack, rate, reason, dispute, customer, glossary, customs, general, handling, packaging, loading, price, priority, regulatory, safety, ship-line, supplier, transport, delivery, quarantine, tax, other] | note key must be a valid value |
