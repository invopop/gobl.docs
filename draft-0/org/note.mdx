...
| ----- | ---- | ------------------------- |
| <code>text</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ORG-NOTE-01`<br />Note text is required |
| <code>key</code> | <ul class="gobl-test"><li>One of [goods, payment, payment-method, payment-term, legal, dangerous-goods, ack, rate, reason, dispute, customer, glossary, customs, general, handling, packaging, loading, price, priority, regulatory, safety, ship-line, supplier, transport, delivery, quarantine, tax, other]</li></ul> | `GOBL-ORG-NOTE-02`<br />Note key must be a valid value |
