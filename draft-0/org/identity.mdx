...
| ----- | ---- | ------------------------- |
| <small>document</small> | <ul class="gobl-test"><li>Key and type must not be used together</li></ul> | `GOBL-ORG-IDENTITY-03`<br />Identity must have either a key or type defined, but not both |
| <code>code</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ORG-IDENTITY-01`<br />Identity code must be provided |
| <code>scope</code> | <ul class="gobl-test"><li>One of [tax, legal]</li></ul> | `GOBL-ORG-IDENTITY-02`<br />Identity scope when provided must be either 'tax' or 'legal' |
