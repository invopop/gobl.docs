...
| ----- | ---- | ------------------------- |
| <code>type</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-ORDER-01`<br />Type is required |
| <code>type</code> | <ul class="gobl-test"><li>One of [purchase, sale, quote]</li></ul> | `GOBL-BILL-ORDER-02`<br />Type is not valid |
| <code>issue_date</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Present</li></ul> | `GOBL-BILL-ORDER-03`<br />Issue date is required |
| <code>currency</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Present</li></ul> | `GOBL-BILL-ORDER-04`<br />Currency is required |
| <code>supplier</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-ORDER-05`<br />Supplier is required |
| <code>lines</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-ORDER-06`<br />Lines are required |
