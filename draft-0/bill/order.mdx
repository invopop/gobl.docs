...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-ORDER-01</code> | type | present | type is required |
| <code>GOBL-BILL-ORDER-02</code> | type | one of [purchase, sale, quote] | type is not valid |
| <code>GOBL-BILL-ORDER-03</code> | issue_date | present | issue date is required |
| <code>GOBL-BILL-ORDER-04</code> | currency | present | currency is required |
| <code>GOBL-BILL-ORDER-05</code> | supplier | present | supplier is required |
| <code>GOBL-BILL-ORDER-06</code> | lines | present | lines are required |
