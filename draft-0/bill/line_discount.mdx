...
| ----- | ---- | ------------------------- |
| <code>percent</code> | <ul class="gobl-test"><li>Base != nil</li><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-LINEDISCOUNT-01`<br />Percent is required when base is set |
