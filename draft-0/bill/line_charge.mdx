...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-LINECHARGE-01</code> | percent | Base != nil; present | percent is required when base is set |
| <code>GOBL-BILL-LINECHARGE-02</code> | quantity | Base != nil || Percent != nil; empty | quantity must be blank with base or percent |
| <code>GOBL-BILL-LINECHARGE-03</code> | rate | Base != nil || Percent != nil; empty | rate must be blank with base or percent |
| <code>GOBL-BILL-LINECHARGE-04</code> | unit | Quantity == nil; empty | unit must be blank without quantity |
| <code>GOBL-BILL-LINECHARGE-05</code> | rate | Quantity != nil; present | rate is required when quantity is set |
