...
| Issuer           | `issuer`     | [org.Party](/draft-0/org/party)                       |      | Issuer represents a third party responsible for issuing the invoice, but is not responsible for tax. Some tax regimes and formats require this field. |
