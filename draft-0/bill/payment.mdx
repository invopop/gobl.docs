...
| `methods` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-PAYMENT-03`<br />Payment methods are required; sum of method amounts must equal the document total |
