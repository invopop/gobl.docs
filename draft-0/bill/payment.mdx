...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-PAYMENT-01</code> | type | present | payment type is required |
| <code>GOBL-BILL-PAYMENT-02</code> | type | one of [request, advice, receipt] | payment type is not valid |
| <code>GOBL-BILL-PAYMENT-03</code> | method | present | payment method is required |
| <code>GOBL-BILL-PAYMENT-04</code> | issue_date | present | payment issue date is required |
| <code>GOBL-BILL-PAYMENT-05</code> | currency | present | payment currency is required |
| <code>GOBL-BILL-PAYMENT-06</code> | supplier | present | payment supplier is required |
| <code>GOBL-BILL-PAYMENT-07</code> | lines | present | payment lines are required |
