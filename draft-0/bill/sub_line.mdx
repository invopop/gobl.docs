...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-SUBLINE-01</code> | i | present | index is required |
| <code>GOBL-BILL-SUBLINE-02</code> | quantity | present | quantity is required |
| <code>GOBL-BILL-SUBLINE-03</code> | item | present | item is required |
| <code>GOBL-BILL-SUBLINE-04</code> | sum | item has price; present | sum is required when item has a price |
| <code>GOBL-BILL-SUBLINE-05</code> | total | item has price; present | total is required when item has a price |
