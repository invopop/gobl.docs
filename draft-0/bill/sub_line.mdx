...
| ----- | ---- | ------------------------- |
| <code>i</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Present</li></ul> | `GOBL-BILL-SUBLINE-01`<br />Index is required |
| <code>quantity</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-SUBLINE-02`<br />Quantity is required |
| <code>item</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-SUBLINE-03`<br />Item is required |
| <code>sum</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Item has price</li><li>Present</li></ul> | `GOBL-BILL-SUBLINE-04`<br />Sum is required when item has a price |
| <code>total</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Item has price</li><li>Present</li></ul> | `GOBL-BILL-SUBLINE-05`<br />Total is required when item has a price |
