...
| Method     | `method`     | [cbc.Key](/draft-0/cbc/key)                |      | Correction method as defined by the tax regime.                                                       |
| Changes    | `changes`    | array of [cbc.Key](/draft-0/cbc/key)       |      | Changes keys that describe the specific changes according to the tax regime.                          |
