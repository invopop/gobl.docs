...
| `other` | Status to be determined by other codes or details listed in the line. |
...
| `key` | <ul class="gobl-test"><li>One of [issued, acknowledged, processing, querying, rejected, accepted, paid, error, other]</li></ul> | `GOBL-BILL-STATUSLINE-02`<br />Status line key is not valid |
