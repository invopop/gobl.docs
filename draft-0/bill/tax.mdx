...
`https://gobl.org/draft-0/bill/order#/$defs/Tax`
...
| Value            | Description                                                                                 |
|------------------|---------------------------------------------------------------------------------------------|
| `sum-then-round` | The default method of calculating the totals in GOBL, and provides the best results         |
...
| `round-then-sum` | The alternative method of calculating the totals that will first round all the amounts      |
