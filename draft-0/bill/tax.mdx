...
| ----- | ---- | ------------------------- |
| `rounding` | <ul class="gobl-test"><li>One of [precise, currency]</li></ul> | `GOBL-BILL-TAX-01`<br />Rounding model is not valid |
| `point` | <ul class="gobl-test"><li>One of [issue, delivery, payment]</li></ul> | `GOBL-BILL-TAX-02`<br />Tax point is not valid |
