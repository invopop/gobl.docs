...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-INVOICE-01</code> | type | present | invoice type is required |
| <code>GOBL-BILL-INVOICE-02</code> | type | one of [standard, proforma, corrective, credit-note, debit-note, other] | invoice type is not valid |
| <code>GOBL-BILL-INVOICE-03</code> | issue_date | not zero | invoice issue date is required |
| <code>GOBL-BILL-INVOICE-04</code> | currency | present | invoice currency is required |
| <code>GOBL-BILL-INVOICE-05</code> | supplier | present | invoice supplier is required |
| <code>GOBL-BILL-INVOICE-06</code> | supplier.name | present | invoice supplier name is required |
| <code>GOBL-BILL-INVOICE-07</code> | customer.name | has tax ID code; present | invoice customer name required when tax ID is set |
| <code>GOBL-BILL-INVOICE-08</code> | lines[*].item.price | present | invoice line item price is required |
| <code>GOBL-BILL-INVOICE-09</code> | totals | present | invoice totals are required |
| <code>GOBL-BILL-INVOICE-10</code> | lines | no discounts or charges; present | invoice lines are required without discounts or charges |
