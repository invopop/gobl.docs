...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-BILL-DELIVERY-01</code> | type | present | type is required |
| <code>GOBL-BILL-DELIVERY-02</code> | type | one of [advice, note, waybill, receipt] | type is not valid |
| <code>GOBL-BILL-DELIVERY-03</code> | issue_date | present | issue date is required |
| <code>GOBL-BILL-DELIVERY-04</code> | supplier | present | supplier is required |
| <code>GOBL-BILL-DELIVERY-05</code> | lines | present | lines are required |
