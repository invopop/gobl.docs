...
| Type | `type` | [cbc.Key](/draft-0/cbc/key) | Type of delivery document. |
...
| `other` | Any other type of delivery that does not fit into the standard categories and implies that any scenarios defined in tax regimes or addons will not be applied. This is useful for being able to create deliveries with custom types in extensions, but is not recommended for general use. |
...
| ----- | ---- | ------------------------- |
| `type` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-01`<br />Type is required |
| `type` | <ul class="gobl-test"><li>One of [advice, note, waybill, receipt, other]</li></ul> | `GOBL-BILL-DELIVERY-02`<br />Type is not valid |
| `issue_date`<br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Present</li></ul> | `GOBL-BILL-DELIVERY-03`<br />Issue date is required |
| `supplier` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-04`<br />Supplier is required |
| `lines` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-05`<br />Lines are required |
