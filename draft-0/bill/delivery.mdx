...
| ----- | ---- | ------------------------- |
| <code>type</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-01`<br />Type is required |
| <code>type</code> | <ul class="gobl-test"><li>One of [advice, note, waybill, receipt]</li></ul> | `GOBL-BILL-DELIVERY-02`<br />Type is not valid |
| <code>issue_date</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Present</li></ul> | `GOBL-BILL-DELIVERY-03`<br />Issue date is required |
| <code>supplier</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-04`<br />Supplier is required |
| <code>lines</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-BILL-DELIVERY-05`<br />Lines are required |
