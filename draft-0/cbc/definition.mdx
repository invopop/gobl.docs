...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-CBC-DEFINITION-02</code> |  | string(Code) != '' || string(Key) != '' | definition must have either a key or a code, and not both |
| <code>GOBL-CBC-DEFINITION-01</code> | name | present | name is required |
| <code>GOBL-CBC-DEFINITION-03</code> | pattern | is a regexp | pattern must be a valid regular expression |
