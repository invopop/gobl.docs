...
| ----- | ---- | ------------------------- |
| <code>key</code> | <ul class="gobl-test"><li>One of [end-of-month, due-date, deferred, proximo, instant, elective, pending, advanced, delivery, undefined]</li></ul> | `GOBL-PAY-TERMS-01`<br />Key must be valid |
