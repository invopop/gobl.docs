...
Behind the scenes, the builder uses the GOBL compiled using the new WASM (web assembly) frameworks for Go, so there is no server-side logic, and no data leaves your browser.
