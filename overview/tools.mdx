...
- [GOBL CLI](https://github.com/invopop/gobl.cli) - command line interface, streaming server, and [WASM](https://webassembly.org/) binary, that leverage the Go validation and calculation methods to complete GOBL envelopes and payloads. 
