...
Single mathematical operations such as multiplication and division are performed using floats and then rounded using the standard Go math package to maintain the original precision.
