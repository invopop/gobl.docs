...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-SG-BILL-INVOICE-01</code> | supplier | context: regime in [SG]; has GST tax ID code or UEN identity | invoice supplier in Singapore must have a GST tax ID code or a UEN identity |
</Accordion>
<Accordion title="org.Identity">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-SG-ORG-IDENTITY-01</code> | code | type in [UEN]; valid UEN | identity code for type UEN must be valid |
</Accordion>
<Accordion title="tax.Identity">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-SG-TAX-IDENTITY-01</code> | code | code in [SG]; valid | invalid Singaporean tax identity code |
</Accordion>
</AccordionGroup>