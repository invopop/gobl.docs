...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-ES-BILL-INVOICE-01</code> | supplier | context: regime in [ES]; present | invoice supplier in Spain is required |
| <code>GOBL-ES-BILL-INVOICE-02</code> | supplier.tax_id | context: regime in [ES]; present | invoice supplier tax ID in Spain is required |
| <code>GOBL-ES-BILL-INVOICE-03</code> | supplier.tax_id.code | context: regime in [ES]; present | invoice supplier tax ID code in Spain is required |
</Accordion>
<Accordion title="tax.Identity">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-ES-TAX-IDENTITY-01</code> | code | code in [ES]; valid | invalid Spanish VAT identity code format or checksum |
</Accordion>
</AccordionGroup>