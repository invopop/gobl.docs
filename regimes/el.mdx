...
| ---- | ---- | ---- | -------- | ----------- |
| `general` | `standard` | General rate | 24% |  |
| `reduced` | `standard` | Reduced rate | 13% |  |
| `super-reduced` | `standard` | Super-reduced rate | 6% |  |
| `general+island` | `standard` | Standard rate (Island) | 17% |  |
| `reduced+island` | `standard` | Reduced rate (Island) | 9% |  |
| `super-reduced+island` | `standard` | Super-reduced rate (Island) | 4% |  |
