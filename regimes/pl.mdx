...
<AccordionGroup>
<Accordion description="Key: pl-ksef-vat-special" title="Special VAT Extensions for KSeF">

| Code | Name |
| ---- | ---- |
| <code>taxi</code> | Taxi Rate |
</Accordion>
<Accordion description="Key: pl-ksef-vat-zero" title="Zero VAT Extensions for KSeF">
...
<Accordion description="Key: pl-ksef-effective-date" title="Effective date code.">
