...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-PL-BILL-INVOICE-01</code> | supplier.tax_id.code | context: regime in [PL]; present | supplier tax ID code required |
</Accordion>
<Accordion title="tax.Identity">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-PL-TAX-IDENTITY-01</code> | code | code in [PL]; valid | invalid Polish VAT identity code |
</Accordion>
</AccordionGroup>