...
**Output:**
- **Note:** Reverse Charge / Autoliquidation de la TVA - Article 283-1 du CGI. Le client est redevable de la TVA. (legal)
</Accordion>
...
| ----- | ---- | ------------------------- |
| <code>supplier</code> | <ul class="gobl-test"><li>Context: regime in [FR]</li><li>Has tax ID code or SIREN/SIRET identity</li></ul> | `GOBL-FR-BILL-INVOICE-01`<br />Invoice supplier must have a tax ID code or a SIREN/SIRET identity |
</Accordion>
<Accordion title="org.Identity">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>code</code> | <ul class="gobl-test"><li>Has a type in [SIREN]</li><li>Matches ^\d{9}$</li></ul> | `GOBL-FR-ORG-IDENTITY-01`<br />Identity code for type SIREN must be valid |
| <code>code</code> | <ul class="gobl-test"><li>Has a type in [SIRET]</li><li>Matches ^\d{14}$</li></ul> | `GOBL-FR-ORG-IDENTITY-02`<br />Identity code for type SIRET must be valid |
</Accordion>
<Accordion title="tax.Identity">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>code</code> | <ul class="gobl-test"><li>Code in [FR]</li><li>Valid</li></ul> | `GOBL-FR-TAX-IDENTITY-01`<br />Invalid French VAT identity code format or checksum |
</Accordion>
</AccordionGroup>