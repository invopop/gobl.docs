...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-AR-BILL-INVOICE-01</code> | supplier.tax_id | context: regime in [AR]; present | invoice supplier tax ID required for Argentine regime |
</Accordion>
<Accordion title="tax.Identity">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-AR-TAX-IDENTITY-01</code> | code | code in [AR]; valid | invalid Argentine tax identity code |
</Accordion>
</AccordionGroup>