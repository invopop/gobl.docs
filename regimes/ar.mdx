...
| ----- | ---- | ------------------------- |
| <code>supplier.tax_id</code> | <ul class="gobl-test"><li>Context: regime in [AR]</li><li class="gobl-test-present">Present</li></ul> | `GOBL-AR-BILL-INVOICE-01`<br />Invoice supplier tax ID required for Argentine regime |
</Accordion>
<Accordion title="tax.Identity">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>code</code> | <ul class="gobl-test"><li>Code in [AR]</li><li>Valid</li></ul> | `GOBL-AR-TAX-IDENTITY-01`<br />Invalid Argentine tax identity code |
</Accordion>
</AccordionGroup>