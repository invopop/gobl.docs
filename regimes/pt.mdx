...
| <code>type</code> | <ul class="gobl-test"><li>Context: regime in [PT]</li><li>One of [standard, credit-note, debit-note, proforma, other]</li></ul> | `GOBL-PT-BILL-INVOICE-01`<br />Invoice type is not valid for Portugal |
...
| <code>totals.due</code> | <ul class="gobl-test"><li>Context: regime in [PT]</li><li>Min 0</li></ul> | `GOBL-PT-BILL-INVOICE-07`<br />Due amount must be zero or positive |
</Accordion>
