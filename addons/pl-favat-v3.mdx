...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-11</code> |  | JST identity | customer requires identity with role '8' and code for JST |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-12</code> |  | GroupVAT identity | customer requires identity with role '10' and code for GroupVAT |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-13</code> |  | exemption note present | missing exemption note |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-14</code> |  | single exemption note | too many exemption notes |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-01</code> | type | one of [standard, credit-note] | invoice type must be standard or credit-note |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-02</code> | preceding[*].issue_date | present | preceding issue date is required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-03</code> | preceding[*].code | present | preceding code is required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-04</code> | supplier | present | supplier is required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-05</code> | supplier.name | present | supplier name is required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-06</code> | supplier.addresses | present | supplier addresses are required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-07</code> | supplier.addresses | first address country | supplier first address must have a country |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-08</code> | supplier.addresses | first address street | supplier first address must have a street |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-09</code> | customer | not simplified; present | customer is required |
| <code>GOBL-PL-FAVAT-V3-BILL-INVOICE-10</code> | customer.tax_id | not simplified; present | customer tax ID is required |
</Accordion>
<Accordion title="tax.Combo">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-PL-FAVAT-V3-TAX-COMBO-01</code> | ext | ext require [pl-favat-tax-category] | tax combo requires 'pl-favat-tax-category' extension |
</Accordion>
<Accordion title="pay.Advance">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-PL-FAVAT-V3-PAY-ADVANCE-01</code> | date | present | advance payment date is required |
</Accordion>
</AccordionGroup>