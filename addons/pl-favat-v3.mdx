...
| `customer.tax_id` | <ul class="gobl-test"><li>Not simplified</li><li class="gobl-test-present">Present</li></ul> | `GOBL-PL-FAVAT-V3-BILL-INVOICE-10`<br />Customer tax ID is required |
</Accordion>
