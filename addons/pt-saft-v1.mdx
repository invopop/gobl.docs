...
| <code>totals.payable</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-PT-SAFT-V1-BILL-INVOICE-09`<br />Must be no less than 0 |
| <code>totals.due</code> | <ul class="gobl-test"><li>Is invoice-receipt</li><li>Equals 0</li></ul> | `GOBL-PT-SAFT-V1-BILL-INVOICE-10`<br />Must be equal to 0 |
...
| <code>sum</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-PT-SAFT-V1-BILL-LINE-02`<br />Must be no less than 0 |
| <code>total</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-PT-SAFT-V1-BILL-LINE-03`<br />Must be no less than 0 |
