...
| `tax.categories[*].rates[*].ext` | <ul class="gobl-test"><li>Ext require [pt-region, pt-saft-tax-rate]</li></ul> | `GOBL-PT-SAFT-V1-BILL-PAYMENTLINE-01`<br />Region and tax rate are required |
| `tax.categories[*].rates[*].ext` | <ul class="gobl-test"><li>Exempt requires exemption</li></ul> | `GOBL-PT-SAFT-V1-BILL-PAYMENTLINE-02`<br />Exemption is required when tax rate is exempt |
</Accordion>
</AccordionGroup>