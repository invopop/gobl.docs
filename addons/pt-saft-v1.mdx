...
<AccordionGroup>
<Accordion description="Key: pt-saft-invoice-type" title="Invoice Type">
...
<Accordion description="Key: pt-saft-tax-rate" title="Tax Rate Code">
...
<Accordion description="Key: pt-saft-exemption" title="Tax exemption reason code">
