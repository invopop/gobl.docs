...
Module: [github.com/invopop/gobl.pt.saft](https://github.com/invopop/gobl.pt.saft)
...
<Accordion title="standard, #cash-vat">
...
<Accordion title="pt-saft-cash-vat">
...
| <small>Payment</small> | <ul class="gobl-test"><li>Method dates</li></ul> | `GOBL-PT-SAFT-BILL-PAYMENT-11`<br />Payment method dates must match the issue date |
...
| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <small>Delivery</small> | <ul class="gobl-test"><li>Has movement type</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-01`<br />Delivery tax requires 'pt-saft-movement-type' extension |
| <small>Delivery</small> | <ul class="gobl-test"><li>Series format</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-02`<br />Delivery series format must be valid |
| <small>Delivery</small> | <ul class="gobl-test"><li>Code format</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-03`<br />Delivery code format must be valid |
| `supplier.tax_id` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-04`<br />Delivery supplier tax ID is required |
| `supplier.tax_id.code` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-05`<br />Delivery supplier tax ID code is required |
| `despatch_date` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-06`<br />Delivery despatch date is required |
| `preceding` | <ul class="gobl-test"><li>Length between 0 and 1</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-07`<br />Delivery preceding must have at most one entry |
| `preceding[*].series` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-08`<br />Delivery preceding series is required |
| `preceding[*].code` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-PT-SAFT-BILL-DELIVERY-09`<br />Delivery preceding code is required |
</Accordion>
...
<Accordion title="tax.CategoryTotal">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| `rates[*].ext` | <ul class="gobl-test"><li>Is VAT</li><li>Ext require [pt-region, pt-saft-tax-rate]</li></ul> | `GOBL-PT-SAFT-TAX-CATEGORYTOTAL-01`<br />Region and tax rate are required |
| `rates[*].ext` | <ul class="gobl-test"><li>Is VAT</li><li>Exempt requires exemption</li></ul> | `GOBL-PT-SAFT-TAX-CATEGORYTOTAL-02`<br />Exemption is required when tax rate is exempt |
</Accordion>
...
<Accordion title="tax.Note">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| `text` | <ul class="gobl-test"><li>Withholding note</li><li>Length between 0 and 60</li></ul> | `GOBL-PT-SAFT-TAX-NOTE-02`<br />The length must be at most 60 |
</Accordion>
