...
| `tax.prices_include` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-TICKET-BILL-INVOICE-02`<br />Prices_include is required |
| `tax.prices_include` | <ul class="gobl-test"><li>One of [VAT]</li></ul> | `GOBL-IT-TICKET-BILL-INVOICE-03`<br />Prices_include must be VAT |
