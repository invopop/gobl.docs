...
| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <small>Terms</small> | <ul class="gobl-test"><li>Has due dates or notes</li></ul> | `GOBL-EU-EN16931-PAY-TERMS-01`<br />Either due_dates or notes must be provided (BR-CO-25) |
</Accordion>
