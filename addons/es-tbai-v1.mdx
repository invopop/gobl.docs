...
| `customer.tax_id` | <ul class="gobl-test"><li>Non-simplified</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-TBAI-V1-BILL-INVOICE-08`<br />Customer tax ID is required |
