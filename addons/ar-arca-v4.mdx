...
supported. See the [Argentina regime](/regimes/ar#correction-definitions)
for the supported invoice types.
...
| `customer` | <ul class="gobl-test"><li>Has tax ID or identity</li></ul> | `GOBL-AR-ARCA-BILL-INVOICE-10`<br />Must have a tax_id, or an identity with ext 'ar-arca-identity-type' |
