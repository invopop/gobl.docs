...
**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:2.1</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>goods</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:1.1</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>goods</code>, <code>export</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:1.3</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>goods</code>, <code>export</code>, <code>eu</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:1.2</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>goods</code>, <code>self-billed</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:1.4</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>services</code>, <code>export</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:2.3</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>services</code>, <code>export</code>, <code>eu</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:2.2</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:5.1</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:11.3</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>goods</code>, <code>simplified</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:11.1</code>
</Accordion>
...
**Filters:**
- **Types:** <code>standard</code>
- **Tags:** <code>services</code>, <code>simplified</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:11.2</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:11.4</code>
</Accordion>
...
**Filters:**
- **Types:** <code>credit-note</code>
- **Tags:** <code>goods</code>, <code>simplified</code>, <code>self-billed</code>

**Output:**
- **Extensions:** <code>gr-mydata-invoice-type:11.5</code>
</Accordion>
...
| Code | Name |
| ---- | ---- |
| <code>1</code> | Withholding Tax |
| <code>2</code> | Fee |
| <code>3</code> | Other Tax |
| <code>4</code> | Stamp Duty |
| <code>5</code> | Deduction |
</Accordion>
### Fee category	
...
| Code | Name |
| ---- | ---- |
| <code>1</code> | Monthly account up to 50 euros 12% |
| <code>2</code> | Monthly account from 50.01 to 100 euros 15% |
| <code>3</code> | Monthly account from 100.01 to 150 euros 18% |
| <code>4</code> | Monthly account from 150.01 euros and above 20% |
| <code>5</code> | Mobile telephony fee based on call time value (12%) |
| <code>6</code> | Subscription television fee 10% |
| <code>7</code> | Fixed-line subscription fee 5% |
| <code>8</code> | Environmental fee & plastic bag v. 2339/2001 art. 6a 0.07 euros per item |
| <code>9</code> | Postal service contribution 2% |
| <code>10</code> | Other fees |
| <code>11</code> | Petroleum fees |
| <code>12</code> | Postal service contribution |
| <code>13</code> | Monthly account per connection (10%) |
| <code>14</code> | Mobile and mobile telephony fee based on call time value (10%) |
| <code>15</code> | Mobile and mobile telephony fee for natural persons aged 15 to 29 years (0%) |
| <code>16</code> | Environmental protection contribution for plastic products 0.04 cents per item [article 4 v. 4736/2020] |
| <code>17</code> | Recycling fee 0.08 cents per item [article 80 v. 4819/2021] |
| <code>18</code> | Accommodation fee |
| <code>19</code> | Fee on gross revenues of restaurants and related establishments |
| <code>20</code> | Fee on gross revenues of entertainment centers |
| <code>21</code> | Fee on gross revenues of casinos |
| <code>22</code> | Other fees on gross revenues |
</Accordion>
...
| Code | Name |
| ---- | ---- |
| <code>1</code> | a1) fire insurance premiums 20% |
| <code>2</code> | a2) fire insurance premiums 20% |
| <code>3</code> | b) life insurance premiums 4% |
| <code>4</code> | c) insurance premiums for other branches 15% |
| <code>5</code> | d) tax-exempt insurance premiums 0% |
| <code>6</code> | Hotels 1-2 stars 0.50 € |
| <code>7</code> | Hotels 3 stars 1.50 € |
| <code>8</code> | Hotels 4 stars 3.00 € |
| <code>9</code> | Hotels 4 stars 4.00 € |
| <code>10</code> | Rented - furnished rooms - apartments 0.50 € |
| <code>11</code> | Special tax on advertisements broadcast on television (EFTD) 5% |
| <code>12</code> | 3.1 Luxury tax 10% on the taxable value for intra-Community acquisitions and imported from third countries 10% |
| <code>13</code> | 3.2 Luxury tax 10% on the selling price before VAT for domestically produced goods 10% |
| <code>14</code> | State rights on casino tickets (80% on the ticket) |
| <code>15</code> | Fire insurance premiums 20% |
| <code>16</code> | Other Customs Duties-Taxes |
| <code>17</code> | Other Taxes |
| <code>18</code> | Charges of Other Taxes |
| <code>19</code> | EFK |
| <code>20</code> | Hotels 1-2 stars 1.50€ (per Room/Night) |
| <code>21</code> | Hotels 3 stars 3.00€ (per Room/Night) |
| <code>22</code> | Hotels 4 stars 7.00€ (per Room/Night) |
| <code>23</code> | Hotels 5 stars 10.00€ (per Room/Night) |
| <code>24</code> | Rented furnished rooms – apartments 1.50€ (per Room/Night) |
| <code>25</code> | Short-term rental properties 1.50€ |
| <code>26</code> | Short-term rental properties detached houses over 80 sq.m. 10.00€ |
| <code>27</code> | Self-catering accommodation – tourist furnished villas (villas) 10.00€ |
| <code>28</code> | Short-term rental properties 0.50€ |
| <code>29</code> | Short-term rental properties detached houses over 80 sq.m. 4.00€ |
| <code>30</code> | Self-catering accommodation – tourist furnished villas (villas) 4.00€ |
</Accordion>
...
| Code | Name |
| ---- | ---- |
| <code>1</code> | Coefficient 1.2% |
| <code>2</code> | Coefficient 2.4% |
| <code>3</code> | Coefficient 3.6% |
| <code>4</code> | Other cases |
</Accordion>
...
| ----- | ---- | ------------------------- |
| <code>series</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-01`<br />Series is required |
| <code>tax</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-02`<br />Tax is required |
| <code>tax.ext</code> | <ul class="gobl-test"><li>Ext require [gr-mydata-invoice-type]</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-03`<br />Tax requires 'gr-mydata-invoice-type' extension |
| <code>supplier.tax_id</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-04`<br />Supplier tax ID is required |
| <code>supplier.tax_id.code</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-18`<br />Supplier tax ID code is required |
| <code>customer</code> | <ul class="gobl-test"><li>Requires customer</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-05`<br />Customer is required |
| <code>customer.tax_id</code> | <ul class="gobl-test"><li>Requires customer</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-06`<br />Customer tax ID is required |
| <code>customer.addresses</code> | <ul class="gobl-test"><li>Requires customer</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-07`<br />Customer addresses are required |
| <code>customer.addresses[*].locality</code> | <ul class="gobl-test"><li>Requires customer</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-08`<br />Customer address locality is required |
| <code>customer.addresses[*].code</code> | <ul class="gobl-test"><li>Requires customer</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-09`<br />Customer address code is required |
| <code>lines[*].total</code> | <ul class="gobl-test"><li>Min 0</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-10`<br />Line total must be positive |
| <code>lines[*].total</code> | <ul class="gobl-test"><li>Not zero</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-11`<br />Line total must not be zero |
| <code>lines[*].item.ext</code> | <ul class="gobl-test"><li>Income ext pair</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-12`<br />Item income extensions 'gr-mydata-income-cat' and 'gr-mydata-income-type' must both be present |
| <code>discounts</code> | <ul class="gobl-test"><li>Empty</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-13`<br />Discounts are not supported by mydata |
| <code>payment</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-14`<br />Payment is required |
| <code>payment</code> | <ul class="gobl-test"><li>Has instructions or advances</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-15`<br />Payment instructions are required when no advances |
| <code>preceding</code> | <ul class="gobl-test"><li>Invoice type in [credit-note]</li><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-16`<br />Preceding documents are required for credit notes |
| <code>preceding[*].stamps</code> | <ul class="gobl-test"><li>Stamps have iapr-mark</li></ul> | `GOBL-GR-MYDATA-V1-BILL-INVOICE-17`<br />Preceding document requires 'iapr-mark' stamp |
</Accordion>
<Accordion title="bill.Charge">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>ext</code> | <ul class="gobl-test"><li>Ext allow one of [gr-mydata-fee, gr-mydata-other-tax, gr-mydata-stamp-duty]</li></ul> | `GOBL-GR-MYDATA-V1-BILL-CHARGE-01`<br />Only one of fee, other-tax, or stamp-duty allowed |
| <code>ext</code> | <ul class="gobl-test"><li>Tax type is fee</li><li>Ext require [gr-mydata-fee]</li></ul> | `GOBL-GR-MYDATA-V1-BILL-CHARGE-02`<br />Charge with fee tax type requires 'gr-mydata-fee' extension |
| <code>ext</code> | <ul class="gobl-test"><li>Tax type is other tax</li><li>Ext require [gr-mydata-other-tax]</li></ul> | `GOBL-GR-MYDATA-V1-BILL-CHARGE-03`<br />Charge with other-tax type requires 'gr-mydata-other-tax' extension |
| <code>ext</code> | <ul class="gobl-test"><li>Tax type is stamp duty</li><li>Ext require [gr-mydata-stamp-duty]</li></ul> | `GOBL-GR-MYDATA-V1-BILL-CHARGE-04`<br />Charge with stamp-duty type requires 'gr-mydata-stamp-duty' extension |
</Accordion>
<Accordion title="tax.Combo">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>ext</code> | <ul class="gobl-test"><li>Category is VAT</li><li>Ext require [gr-mydata-vat-rate]</li></ul> | `GOBL-GR-MYDATA-V1-TAX-COMBO-01`<br />VAT combo requires 'gr-mydata-vat-rate' extension |
| <code>ext</code> | <ul class="gobl-test"><li>VAT with no percent</li><li>Ext require [gr-mydata-exemption]</li></ul> | `GOBL-GR-MYDATA-V1-TAX-COMBO-02`<br />Exempt VAT combo requires 'gr-mydata-exemption' extension |
| <code>ext</code> | <ul class="gobl-test"><li>VAT with income ext</li><li>Ext require [gr-mydata-income-cat, gr-mydata-income-type]</li></ul> | `GOBL-GR-MYDATA-V1-TAX-COMBO-03`<br />Income extensions 'gr-mydata-income-cat' and 'gr-mydata-income-type' must both be present |
</Accordion>
<Accordion title="pay.Instructions">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>key</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-PAY-INSTRUCTIONS-01`<br />Payment instructions key is required |
| <code>ext</code> | <ul class="gobl-test"><li>Ext require [gr-mydata-payment-means]</li></ul> | `GOBL-GR-MYDATA-V1-PAY-INSTRUCTIONS-02`<br />Payment instructions require 'gr-mydata-payment-means' extension |
</Accordion>
<Accordion title="pay.Advance">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>key</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-GR-MYDATA-V1-PAY-ADVANCE-01`<br />Payment advance key is required |
| <code>ext</code> | <ul class="gobl-test"><li>Ext require [gr-mydata-payment-means]</li></ul> | `GOBL-GR-MYDATA-V1-PAY-ADVANCE-02`<br />Payment advance requires 'gr-mydata-payment-means' extension |
</Accordion>
</AccordionGroup>