...
| ---- | ----- | ---- | ----------- |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-01</code> | series | present | series is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-02</code> | tax | present | tax is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-03</code> | tax.ext | ext require [gr-mydata-invoice-type] | tax requires 'gr-mydata-invoice-type' extension |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-04</code> | supplier.tax_id | present | supplier tax ID is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-18</code> | supplier.tax_id.code | present | supplier tax ID code is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-05</code> | customer | requires customer; present | customer is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-06</code> | customer.tax_id | requires customer; present | customer tax ID is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-07</code> | customer.addresses | requires customer; present | customer addresses are required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-08</code> | customer.addresses[*].locality | requires customer; present | customer address locality is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-09</code> | customer.addresses[*].code | requires customer; present | customer address code is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-10</code> | lines[*].total | min 0 | line total must be positive |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-11</code> | lines[*].total | not zero | line total must not be zero |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-12</code> | lines[*].item.ext | income ext pair | item income extensions 'gr-mydata-income-cat' and 'gr-mydata-income-type' must both be present |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-13</code> | discounts | empty | discounts are not supported by mydata |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-14</code> | payment | present | payment is required |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-15</code> | payment | has instructions or advances | payment instructions are required when no advances |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-16</code> | preceding | invoice type in [credit-note]; present | preceding documents are required for credit notes |
| <code>GOBL-GR-MYDATA-V1-BILL-INVOICE-17</code> | preceding[*].stamps | stamps have iapr-mark | preceding document requires 'iapr-mark' stamp |
</Accordion>
<Accordion title="bill.Charge">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-GR-MYDATA-V1-BILL-CHARGE-01</code> | ext | ext allow one of [gr-mydata-fee, gr-mydata-other-tax, gr-mydata-stamp-duty] | only one of fee, other-tax, or stamp-duty allowed |
| <code>GOBL-GR-MYDATA-V1-BILL-CHARGE-02</code> | ext | tax type is fee; ext require [gr-mydata-fee] | charge with fee tax type requires 'gr-mydata-fee' extension |
| <code>GOBL-GR-MYDATA-V1-BILL-CHARGE-03</code> | ext | tax type is other tax; ext require [gr-mydata-other-tax] | charge with other-tax type requires 'gr-mydata-other-tax' extension |
| <code>GOBL-GR-MYDATA-V1-BILL-CHARGE-04</code> | ext | tax type is stamp duty; ext require [gr-mydata-stamp-duty] | charge with stamp-duty type requires 'gr-mydata-stamp-duty' extension |
</Accordion>
<Accordion title="tax.Combo">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-GR-MYDATA-V1-TAX-COMBO-01</code> | ext | category is VAT; ext require [gr-mydata-vat-rate] | VAT combo requires 'gr-mydata-vat-rate' extension |
| <code>GOBL-GR-MYDATA-V1-TAX-COMBO-02</code> | ext | VAT with no percent; ext require [gr-mydata-exemption] | exempt VAT combo requires 'gr-mydata-exemption' extension |
| <code>GOBL-GR-MYDATA-V1-TAX-COMBO-03</code> | ext | VAT with income ext; ext require [gr-mydata-income-cat, gr-mydata-income-type] | income extensions 'gr-mydata-income-cat' and 'gr-mydata-income-type' must both be present |
</Accordion>
<Accordion title="pay.Instructions">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-GR-MYDATA-V1-PAY-INSTRUCTIONS-01</code> | key | present | payment instructions key is required |
| <code>GOBL-GR-MYDATA-V1-PAY-INSTRUCTIONS-02</code> | ext | ext require [gr-mydata-payment-means] | payment instructions require 'gr-mydata-payment-means' extension |
</Accordion>
<Accordion title="pay.Advance">

| Code | Field | Test | Description |
| ---- | ----- | ---- | ----------- |
| <code>GOBL-GR-MYDATA-V1-PAY-ADVANCE-01</code> | key | present | payment advance key is required |
| <code>GOBL-GR-MYDATA-V1-PAY-ADVANCE-02</code> | ext | ext require [gr-mydata-payment-means] | payment advance requires 'gr-mydata-payment-means' extension |
</Accordion>
</AccordionGroup>