...
<AccordionGroup>
<Accordion description="Key: it-sdi-format" title="SDI Transmission Format">	
...
<Accordion description="Key: it-sdi-document-type" title="SDI Document Type">	
...
<Accordion description="Key: it-sdi-fiscal-regime" title="Fiscal Regime Code">
...
<Accordion description="Key: it-sdi-exempt" title="Exemption Code">
...
<Accordion description="Key: it-sdi-retained" title="Retained Tax Payment Reason Code">
...
<Accordion description="Key: it-sdi-payment-means" title="Payment Means">
...
<Accordion description="Key: it-sdi-vat-liability" title="VAT Liability">
