...
| `supplier.addresses[*]` | <ul class="gobl-test"><li>Street or postbox</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-30`<br />Address either street or post office box must be set |
| `supplier.addresses[*].street` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-31`<br />Address street must use Latin-1 characters |
| `supplier.addresses[*].po_box` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-32`<br />Address post office box must use Latin-1 characters |
| `supplier.addresses[*].country` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-33`<br />Address country is required |
| `supplier.addresses[*].locality` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-34`<br />Address locality is required |
| `supplier.addresses[*].locality` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-35`<br />Address locality must use Latin-1 characters |
| `supplier.addresses[*].code` | <ul class="gobl-test"><li>Italian address</li><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-36`<br />Italian address code is required |
| `supplier.addresses[*].code` | <ul class="gobl-test"><li>Italian address</li><li>Matches ^\d{5}$</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-37`<br />Italian address code must be 5 digits |
...
| `customer.addresses[*]` | <ul class="gobl-test"><li>Street or postbox</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-30`<br />Address either street or post office box must be set |
| `customer.addresses[*].street` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-31`<br />Address street must use Latin-1 characters |
| `customer.addresses[*].po_box` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-32`<br />Address post office box must use Latin-1 characters |
| `customer.addresses[*].country` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-33`<br />Address country is required |
| `customer.addresses[*].locality` | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-34`<br />Address locality is required |
| `customer.addresses[*].locality` | <ul class="gobl-test"><li>Latin1</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-35`<br />Address locality must use Latin-1 characters |
| `customer.addresses[*].code` | <ul class="gobl-test"><li>Italian address</li><li class="gobl-test-present">Present</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-36`<br />Italian address code is required |
| `customer.addresses[*].code` | <ul class="gobl-test"><li>Italian address</li><li>Matches ^\d{5}$</li></ul> | `GOBL-IT-SDI-V1-BILL-INVOICE-37`<br />Italian address code must be 5 digits |
