...
| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| `ext` | <ul class="gobl-test"><li>Ext require [it-sdi-payment-means]</li></ul> | `GOBL-IT-SDI-PAY-ADVANCE-01`<br />Payment advance requires 'it-sdi-payment-means' extension |
</Accordion>
</AccordionGroup>