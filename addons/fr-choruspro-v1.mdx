...
| <code>totals</code><br /><small class="gobl-field-calculated">Calculated</small> | <ul class="gobl-test"><li>Framework is paid</li><li>Paid</li></ul> | `GOBL-FR-CHORUSPRO-V1-BILL-INVOICE-06`<br />Must be paid in full for framework 'A2' |
</Accordion>
