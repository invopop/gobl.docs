...
| `customer` | <ul class="gobl-test"><li>Not simplified</li><li>Has tax_id or identity</li></ul> | `GOBL-ES-VERIFACTU-BILL-INVOICE-07`<br />Must have a tax_id or an identity with ext 'es-verifactu-identity-type' |
