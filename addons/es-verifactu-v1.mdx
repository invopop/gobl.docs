...
**Output:**
- **Extensions:** <code>es-verifactu-doc-type:F1</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>es-verifactu-doc-type:F2</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>es-verifactu-doc-type:F3</code>
</Accordion>
...
**Output:**
- **Extensions:** <code>es-verifactu-doc-type:R5</code>
</Accordion>
...
| ----- | ---- | ------------------------- |
| <code>preceding</code> | <ul class="gobl-test"><li>Invoice type in [corrective]</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-01`<br />Preceding documents are required for corrective invoices |
| <code>preceding[*].issue_date</code> | <ul class="gobl-test"><li>Not nil</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-02`<br />Issue date is required |
| <code>preceding[*].tax</code> | <ul class="gobl-test"><li>Not nil</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-03`<br />Preceding invoice tax data is required for corrective invoices |
| <code>customer</code> | <ul class="gobl-test"><li>Simplified</li><li>No identity type ext</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-05`<br />Customer identity type extension not allowed for simplified invoices |
| <code>customer.tax_id</code> | <ul class="gobl-test"><li>Simplified</li><li>Nil</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-04`<br />Customer tax ID must not be set for simplified invoices |
| <code>customer</code> | <ul class="gobl-test"><li>Not simplified</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-06`<br />Customer is required |
| <code>customer</code> | <ul class="gobl-test"><li>Not simplified</li><li>Has tax_id or identity</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-07`<br />Must have a tax_id or an identity with ext 'es-verifactu-v1-identity-type' |
| <code>customer.tax_id.code</code> | <ul class="gobl-test"><li>Not simplified</li><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-08`<br />Tax ID must have a code |
| <code>tax</code> | <ul class="gobl-test"><li class="gobl-test-present">Present</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-09`<br />Tax is required |
| <code>tax.ext</code> | <ul class="gobl-test"><li>Ext require [es-verifactu-doc-type]</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-10`<br />Doc type is required |
| <code>tax.ext</code> | <ul class="gobl-test"><li>Ext 'es-verifactu-doc-type' in [R1, R2, R3, R4, R5]</li><li>Ext require [es-verifactu-correction-type]</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-13`<br />Correction type extension is required |
| <code>tax.ext</code> | <ul class="gobl-test"><li>Invoice type in [standard]</li><li>Ext 'es-verifactu-doc-type' in [F1, F2, F3]</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-11`<br />Doc type extension for standard invoices must be F1, F2, or F3 |
| <code>tax.ext</code> | <ul class="gobl-test"><li>Invoice type in [corrective, credit-note, debit-note]</li><li>Ext 'es-verifactu-doc-type' in [R1, R2, R3, R4, R5]</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-12`<br />Doc type extension for corrective invoices must be R1, R2, R3, R4, or R5 |
| <code>notes[*].text</code> | <ul class="gobl-test"><li>General note</li><li>Length between 0 and 500</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-14`<br />General note text must be 500 characters or less |
| <code>lines[*].taxes</code> | <ul class="gobl-test"><li>One of [VAT, IGIC, IPSI]</li></ul> | `GOBL-ES-VERIFACTU-V1-BILL-INVOICE-15`<br />Must include at least one of VAT, IGIC, or IPSI |
</Accordion>
<Accordion title="tax.Combo">

| Field | Test | Validation Code / Message |
| ----- | ---- | ------------------------- |
| <code>ext</code> | <ul class="gobl-test"><li>Verifactu vat/igic</li><li>Ext require [es-verifactu-regime]</li></ul> | `GOBL-ES-VERIFACTU-V1-TAX-COMBO-01`<br />Extension 'es-verifactu-regime' is required |
| <code>ext</code> | <ul class="gobl-test"><li>Verifactu vat/igic</li><li>Ext allow one of [es-verifactu-op-class, es-verifactu-exempt]</li></ul> | `GOBL-ES-VERIFACTU-V1-TAX-COMBO-03`<br />Cannot use both 'es-verifactu-op-class' and 'es-verifactu-exempt' at the same time |
| <code>ext</code> | <ul class="gobl-test"><li>Ext 'es-verifactu-regime' in [01]</li><li>Ext 'es-verifactu-exempt' not in [E2, E3]</li></ul> | `GOBL-ES-VERIFACTU-V1-TAX-COMBO-02`<br />Exempt codes E2 and E3 not allowed with 'es-verifactu-regime' 01 |
| <code>ext</code> | <ul class="gobl-test"><li>Has percent</li><li>Ext require [es-verifactu-op-class]</li></ul> | `GOBL-ES-VERIFACTU-V1-TAX-COMBO-04`<br />Extension 'es-verifactu-op-class' is required for taxed operations |
</Accordion>
</AccordionGroup>