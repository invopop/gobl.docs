...
| `customer` | <ul class="gobl-test"><li>Status is business-issued</li><li class="gobl-test-present">Present</li></ul> | `GOBL-FR-CTC-FLOW6-BILL-STATUS-07`<br />Status customer is required (BR-FR-CDV-CL-04) |
...
| `lines[*].key` | <ul class="gobl-test"><li>Status type in [response]</li><li>One of [issued, acknowledged, processing, accepted, querying, rejected, error, other]</li></ul> | `GOBL-FR-CTC-FLOW6-BILL-STATUS-23`<br />Status line key must be consistent with status type 'response' |
| `lines[*].key` | <ul class="gobl-test"><li>Status type in [update]</li><li>One of [issued, other]</li></ul> | `GOBL-FR-CTC-FLOW6-BILL-STATUS-24`<br />Status line key must be consistent with status type 'update' |
</Accordion>
