...
| `preceding[*].reason` | <ul class="gobl-test"><li>Invoice type in [debit-note]</li><li class="gobl-test-present">Present</li></ul> | `GOBL-CO-DIAN-V2-BILL-INVOICE-12`<br />Preceding reason is required |
</Accordion>
</AccordionGroup>